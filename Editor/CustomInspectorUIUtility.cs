...
namespace Shiranui_Isuzu.IsuzuToonShader.Utility
{
    /// <summary>
    /// UIに関するUtilityクラス
    /// </summary>
    public static class CustomInspectorUIUtility
    {
        /// <summary>
        /// チェックボックスのスタイル。
        /// </summary>
        ...
        static CustomInspectorUIUtility()
        {
        ...
        internal static void SetKeyword(MaterialProperty property, bool on)
        {
            ...
            foreach (var o in property.targets)
            {
                var target = (Material) o;
